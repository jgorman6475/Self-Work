class 101st_Style_Changer
{
    ...
    class 101st_NoseArt_None
    {
        ...
        statement="_target setObjectTextureGlobal [0,'DBA_Republic\DBA_Vehicles\DBA_AirVehicles\LAAT\1-2\1-2_Base_Hull_CO.paa']";
        showDisabled=0;
        runOnHover=0;
        priority=2.5;
    };
...
/* Please put in Alphabetical Order - Gorman
    ...
    {
        displayName="NAME";
        statement="_target setObjectTextureGlobal [0, '101st_Aux_Mod\Addons\DBA_Republic\DBA_Vehicles\DBA_AirVehicles\LAAT\1-2\Customs\NAME_Hull_CO.paa']";
    };
*/
